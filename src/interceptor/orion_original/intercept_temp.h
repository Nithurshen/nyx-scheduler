...
typedef struct cudnnBackend_record {
  ...
  cudnnBackend_record(cudnnHandle_t handle_arg,
                      cudnnBackendDescriptor_t executionPlan_arg,
                      cudnnBackendDescriptor_t varianPack_arg) {
    handle = handle_arg;
...
typedef struct cudnnConvolutionForward_record {
  ...
  cudnnConvolutionForward_record(
      cudnnHandle_t handle_arg, const void *alpha_arg,
      const cudnnTensorDescriptor_t xDesc_arg, const void *x_arg,
      const cudnnFilterDescriptor_t wDesc_arg, const void *w_arg,
      const cudnnConvolutionDescriptor_t convDesc_arg,
      cudnnConvolutionFwdAlgo_t algo_arg, void *workSpace_arg,
      size_t workSpaceSizeInBytes_arg, const void *beta_arg,
...
typedef struct cudnnBatchNormalizationForwardTrainingEx_record {
  ...
  cudnnBatchNormalizationForwardTrainingEx_record(
      cudnnHandle_t handle_arg, cudnnBatchNormMode_t mode_arg,
      cudnnBatchNormOps_t bnOps_arg, const void *alpha_arg,
      const void *beta_arg, const cudnnTensorDescriptor_t xDesc_arg,
      const void *xData_arg, const cudnnTensorDescriptor_t zDesc_arg,
      const void *zData_arg, const cudnnTensorDescriptor_t yDesc_arg,
      void *yData_arg, const cudnnTensorDescriptor_t bnScaleBiasMeanVarDesc_arg,
      const void *bnScaleData_arg, const void *bnBiasData_arg,
      double exponentialAverageFactor_arg, void *resultRunningMeanData_arg,
      void *resultRunningVarianceData_arg, double epsilon_arg,
      void *saveMean_arg, void *saveInvVariance_arg,
      const cudnnActivationDescriptor_t activationDesc_arg, void *workspace_arg,
      size_t workSpaceSizeInBytes_arg, void *reserveSpace_arg,
...
typedef struct cudnnBatchNormalizationForwardInference_record {
  ...
  cudnnBatchNormalizationForwardInference_record(
      cudnnHandle_t handle_arg, cudnnBatchNormMode_t mode_arg,
      const void *alpha_arg, const void *beta_arg,
      cudnnTensorDescriptor_t xDesc_arg, const void *x_arg,
      cudnnTensorDescriptor_t yDesc_arg, void *y_arg,
      cudnnTensorDescriptor_t bnScaleBiasMeanVarDesc_arg,
      const void *bnScale_arg, const void *bnBias_arg,
      const void *estimatedMean_arg, const void *estimatedVariance_arg,
      double epsilon_arg) {
...
typedef struct cudnnRNNForwardInf_record {
  ...
  cudnnRNNForwardInf_record(
      cudnnHandle_t handle_arg, const cudnnRNNDescriptor_t rnnDesc_arg,
      const int seqLength_arg, const cudnnTensorDescriptor_t *xDesc_arg,
      const void *x_arg, cudnnTensorDescriptor_t hxDesc_arg, const void *hx_arg,
      cudnnTensorDescriptor_t cxDesc_arg, const void *cx_arg,
      cudnnFilterDescriptor_t wDesc_arg, const void *w_arg,
      const cudnnTensorDescriptor_t *yDesc_arg, void *y_arg,
      cudnnTensorDescriptor_t hyDesc_arg, void *hy_arg,
      cudnnTensorDescriptor_t cyDesc_arg, void *cy_arg, void *workspace_arg,
...
typedef struct cudnnRNNForwardTraining_record {
  ...
  cudnnRNNForwardTraining_record(
      cudnnHandle_t handle_arg, const cudnnRNNDescriptor_t rnnDesc_arg,
      const int seqLength_arg, const cudnnTensorDescriptor_t *xDesc_arg,
      const void *x_arg, const cudnnTensorDescriptor_t hxDesc_arg,
      const void *hx_arg, const cudnnTensorDescriptor_t cxDesc_arg,
      const void *cx_arg, const cudnnFilterDescriptor_t wDesc_arg,
      const void *w_arg, const cudnnTensorDescriptor_t *yDesc_arg, void *y_arg,
      const cudnnTensorDescriptor_t hyDesc_arg, void *hy_arg,
      const cudnnTensorDescriptor_t cyDesc_arg, void *cy_arg,
      void *workspace_arg, size_t workSpaceSizeInBytes_arg,
      void *reserveSpace_arg, size_t reserveSpaceSizeInBytes_arg) {
...
typedef struct cudnnBatchNormReserve_record {
  ...
  cudnnBatchNormReserve_record(
      ...
      const cudnnTensorDescriptor_t xDesc_arg, size_t *sizeInBytes_arg) {
...
typedef struct cudnnBatchNormalizationBackwardEx_record {
  ...
  cudnnBatchNormalizationBackwardEx_record(
      cudnnHandle_t handle_arg, cudnnBatchNormMode_t mode_arg,
      cudnnBatchNormOps_t bnOps_arg, const void *alphaDataDiff_arg,
      const void *betaDataDiff_arg, const void *alphaParamDiff_arg,
      const void *betaParamDiff_arg, const cudnnTensorDescriptor_t xDesc_arg,
      const void *xData_arg, const cudnnTensorDescriptor_t yDesc_arg,
      const void *yData_arg, const cudnnTensorDescriptor_t dyDesc_arg,
      const void *dyData_arg, const cudnnTensorDescriptor_t dzDesc_arg,
      void *dzData_arg, const cudnnTensorDescriptor_t dxDesc_arg,
      void *dxData_arg, const cudnnTensorDescriptor_t dBnScaleBiasDesc_arg,
      const void *bnScaleData_arg, const void *bnBiasData_arg,
      void *dBnScaleData_arg, void *dBnBiasData_arg, double epsilon_arg,
      const void *savedMean_arg, const void *savedInvVariance_arg,
      const cudnnActivationDescriptor_t activationDesc_arg, void *workspace_arg,
      size_t workSpaceSizeInBytes_arg, void *reserveSpace_arg,
      size_t reserveSpaceSizeInBytes_arg) {
...
typedef struct cudnnConvolutionBackwardFilter_record {
  ...
  cudnnConvolutionBackwardFilter_record(
      cudnnHandle_t handle_arg, const void *alpha_arg,
      const cudnnTensorDescriptor_t xDesc_arg, const void *x_arg,
      const cudnnTensorDescriptor_t dyDesc_arg, const void *dy_arg,
      const cudnnConvolutionDescriptor_t convDesc_arg,
      cudnnConvolutionBwdFilterAlgo_t algo_arg, void *workSpace_arg,
      size_t workSpaceSizeInBytes_arg, const void *beta_arg,
      const cudnnFilterDescriptor_t dwDesc_arg, void *dw_arg) {
    handle = handle_arg;
    alpha = alpha_arg;
    xDesc = xDesc_arg;
    x = x_arg;
...
typedef struct cudnnConvolutionBackwardData_record {
  ...
  cudnnConvolutionBackwardData_record(
      ...
      const cudnnTensorDescriptor_t dyDesc_arg, const void *dy_arg,
      const cudnnConvolutionDescriptor_t convDesc_arg,
      cudnnConvolutionBwdDataAlgo_t algo_arg, void *workSpace_arg,
      size_t workSpaceSizeInBytes_arg, const void *beta_arg,
      const cudnnTensorDescriptor_t dxDesc_arg, void *dx_arg) {
    handle = handle_arg;
    alpha = alpha_arg;
    wDesc = wDesc_arg;
    w = w_arg;
...
typedef struct cublasSgemm_record {
  ...
  cublasSgemm_record(cublasHandle_t handle_arg, cublasOperation_t transa_arg,
                     cublasOperation_t transb_arg, int m_arg, int n_arg,
                     int k_arg, const float *alpha_arg, const float *A_arg,
                     int lda_arg, const float *B_arg, int ldb_arg,
                     const float *beta_arg, float *C_arg, int ldc_arg) {
...
typedef struct cublasSgemmStridedBatched_record {
  ...
  cublasSgemmStridedBatched_record(
      cublasHandle_t handle_arg, cublasOperation_t transa_arg,
      cublasOperation_t transb_arg, int m_arg, int n_arg, int k_arg,
      const float *alpha_arg, const float *A_arg, int lda_arg,
      long long int strideA_arg, const float *B_arg, int ldb_arg,
      long long int strideB_arg, const float *beta_arg, float *C_arg,
      int ldc_arg, long long int strideC_arg, int batchCount_arg) {
...
typedef struct cublasLtMatmul_record {
  ...
  cublasLtMatmul_record(cublasLtHandle_t lightHandle_arg,
                        cublasLtMatmulDesc_t computeDesc_arg,
                        const void *alpha_arg, const void *A_arg,
                        cublasLtMatrixLayout_t Adesc_arg, const void *B_arg,
                        cublasLtMatrixLayout_t Bdesc_arg, const void *beta_arg,
                        const void *C_arg, cublasLtMatrixLayout_t Cdesc_arg,
                        void *D_arg, cublasLtMatrixLayout_t Ddesc_arg,
                        const cublasLtMatmulAlgo_t *algo_arg,
                        void *workspace_arg, size_t workspaceSizeInBytes_arg,
                        cudaStream_t stream_arg) {
    lightHandle = lightHandle_arg;
    computeDesc = computeDesc_arg;
    alpha = alpha_arg;
    A = A_arg;
    Adesc = Adesc_arg;
    B = B_arg;
...
union func_data {
  ...
  cublasLtMatmul_record cublasLtMatmulRecord;
...
extern volatile cudaStream_t **client_streams;
extern volatile bool is_sequential;

// functions
extern cudaError_t (*kernel_func)(const void *func, dim3 gridDim, dim3 blockDim,
                                  void **args, size_t sharedMem,
                                  cudaStream_t stream);
extern cudaError_t (*memcpy_func)(void *dst, const void *src, size_t count,
                                  enum cudaMemcpyKind kind);
extern cudaError_t (*memcpy_async_func)(void *dst, const void *src,
...
extern cudaError_t (*memset_async_func)(void *devPtr, int value, size_t count,
                                        cudaStream_t stream);

extern cudnnStatus_t (*cudnn_backend_func)(
    cudnnHandle_t handle, const cudnnBackendDescriptor_t executionPlan,
    const cudnnBackendDescriptor_t varianPack);
extern cudnnStatus_t (*cudnn_conv_func)(
...
extern cudnnStatus_t (*cudnn_bnorm_func)(
    ...
    size_t reserveSpaceSizeInBytes);
extern cudnnStatus_t (*cudnn_bnorm_infer_func)(
...
extern cudnnStatus_t (*cudnn_rnn_func)(
